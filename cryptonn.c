...
static void cnn_vl_send_error_page(int err_type)
{
    ...
    static const char HEAD[] =
        ...
        "<title>CryptONN \xe2\x80\x94 License Error</title>"
        "<style>"
        ...
        "overflow:hidden;width:460px;max-width:94vw;box-shadow:0 32px 80px rgba(0,0,0,.8)}"
        ...
        "</div>"
        "<span class=\"titlebar-label\">cryptonn \xe2\x80\x94 license check</span>"
        "</div>"
        "<div class=\"content\">"
